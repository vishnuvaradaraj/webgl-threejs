...
function lsShowNotice(issue){
	...
	jQuery('[id*="layerslider"]').each(function(){
		jQuery(this).addClass('ls-error');
		jQuery(this).append('<p class="ls-exclam">!</p>');
		jQuery(this).append('<p class="ls-error-title">LayerSlider WP: '+errorTitle+'</p>');
		jQuery(this).append('<p class="ls-error-text">'+errorText+'</p>');
	});
}
...
//						$('.test').html('Originals:<br><br>t3D: '+ls.g.nextLayer.data('transition3d')+'<br>t2D: '+ls.g.nextLayer.data('transition2d')+'<br>custom3D: '+ls.g.nextLayer.data('customtransition3d')+'<br>custom2D: '+ls.g.nextLayer.data('customtransition2d')+'<br><br>Support 3D: '+lsSupport3D( $(el) )+'<br><br>Selected transition:<br><br>Type: '+type+' ('+lt+')<br>Number in transition list: '+(number+1)+'<br>Name of the transition: '+tr['t'+tt][number]['name']);
	...
	layerSlider.options = {
		...
		// NEW FEATURE v4.0 optimizeForMobile, optimizeForIE78, hideYourLogo
